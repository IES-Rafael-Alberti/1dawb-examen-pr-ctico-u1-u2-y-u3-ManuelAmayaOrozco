...
def generar_mapa(posicion_jugador: tuple) -> list:
    ...
    :param posicion_jugador: La posicion inicial del jugador.
    ...
    for i in range(DIMENSIONES):
        for j in range(DIMENSIONES):
            if mapa[i][j] != CELDA_TESORO:
                ...
                mapa[posicion_jugador[0]][posicion_jugador[1]] = CELDA_VACIA

    if mapa[posicion_jugador[0]][posicion_jugador[1]] == CELDA_TRAMPA or mapa[posicion_jugador[0]][posicion_jugador[1]] == ARRIBA or mapa[posicion_jugador[0]][posicion_jugador[1]] == ABAJO or mapa[posicion_jugador[0]][posicion_jugador[1]] == DERECHA or mapa[posicion_jugador[0]][posicion_jugador[1]] == IZQUIERDA:
        mapa[posicion_jugador[0]][posicion_jugador[1]] = CELDA_VACIA
...
def imprimir_mapa_oculto(mapa: list):
    ...
    print("  -----------")
    for fila in mapa:
        print("{count} |".format(count = count) + " ".join([simbolo_celda(celda) for celda in fila]) + "|")
        count += 1
    print("  -----------")
...
def muestra_estado_mapa(mapa: list, posicion_jugador: tuple):
    ...
    most_posicion_jugador = list(posicion_jugador)

    most_posicion_jugador[0] += 1
    most_posicion_jugador[1] += 1
    
    print("Tu posición es ({most_posicion_jugador1},{most_posicion_jugador2})".format(most_posicion_jugador1 = most_posicion_jugador[0], most_posicion_jugador2 = most_posicion_jugador[1]))
